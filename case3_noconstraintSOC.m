classdef case3_noconstraintSOC < rl.env.MATLABEnvironment    
properties
...
methods              
    function this = case3_noconstraintSOC()
        ...
        [LD_new,~] = reconfiguration_func(this.load_percent(1), this.pv_KW_max(1),this.wt_KW_max(1),zeros(5,1),zeros(4,1),0);
