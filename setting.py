...
IDX_WIND_MIN = 9
IDX_TOTAL_LOAD = 10
IDX_LINE_LOSSES_MAX = 11
IDX_LINE_LOSSES_MIN = 12
IDX_PREV_GENPOWER_MAX = 13
IDX_PREV_GENPOWER_MIN = 14
IDX_ACTIVE_PMW = np.arange(15, 20) # 5 consumers
IDX_PREV_CURTAILED = np.arange(20, 25) # 5 consumers
IDX_PREV_ACTIVE_PMW = np.arange(25, 30) # 5 consumers
IDX_PREV_ACTIVE_BENEFIT = np.arange(30, 35) # 5 consumers
IDX_MINMARKET_PRICE = 35
IDX_PREV_BUDGET = 36
#IDX_SOC = 37
...
11: "LINE_LOSSES_MAX",
12: "LINE_LOSSES_MIN",
13: "PREV_GENPOWER_MAX",
14: "PREV_GENPOWER_MIN",
}

STATE_NAMES.update({i: f"ACTIVE_PMW_CONSUMER_{i-15}" for i in range(15, 20)})
STATE_NAMES.update({i: f"PREV_CURTAILED_CONSUMER_{i-20}" for i in range(20, 25)})
STATE_NAMES.update({i: f"PREV_ACTIVE_PMW_CONSUMER_{i-25}" for i in range(25, 30)})
STATE_NAMES.update({i: f"PREV_ACTIVE_BENEFIT_CONSUMER_{i-30}" for i in range(30, 35)})
STATE_NAMES[35] = "MINMARKET_PRICE"
STATE_NAMES[36] = "PREV_BUDGET"
