...
%   trainingInfo    - training statistics from the RL training session
    ...
    if nargin >= 14 && ~isempty(resume_from) 
        ...
        elseif algo == "SAC"
            ...
            agentOpts.EntropyWeightOptions.TargetEntropy = -prod(actInfo.Dimension) / 2; % Automatic entropy tuning
            agentOpts.EntropyWeightOptions.GradientThreshold = 1000;
            agentOpts.EntropyWeightOptions.EntropyWeight = 0.05;
            % Create SAC agent
            % Optimizer settings
